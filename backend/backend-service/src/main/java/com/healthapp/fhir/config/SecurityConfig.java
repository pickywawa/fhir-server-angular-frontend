...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Everything under /fhir requires a valid JWT
    ...
    /**
     * Maps Keycloak realm roles from the JWT claim "realm_access.roles"
     * to Spring Security GrantedAuthorities with prefix "ROLE_".
     */
    @Bean
